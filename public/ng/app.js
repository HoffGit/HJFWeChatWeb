...
app.config(['$routeProvider', '$locationProvider', '$resourceProvider',
	function ($routeProvider, $locationProvider, $resourceProvider) {
		...
		$routeProvider.when('/company/info', { templateUrl: ('partial/company'), permission: 'none' });
		$routeProvider.when('/company/cultural', { templateUrl: ('partial/cultural'), permission: 'none' });
		$routeProvider.when('/company/thanks', { templateUrl: ('partial/thanks'), permission: 'none' });	
